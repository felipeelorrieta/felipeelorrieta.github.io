...
- Familiarizar al alumno con la teor´ıa de series de tiempo y sus aplicaciones
:::
...
::: {.callout-tip collapse="true" icon=false}
## Unidad 2: Descomposición clásica de una serie de Tiempo.
...
::: {.callout-tip collapse="true" icon=false}
## Unidad 3: Procesos Lineales.

    3.1. Definición.
    3.2. Procesos Autoregresivos (AR)
    3.3. Procesos de Medias Móviles (MA)
    3.4. Procesos Mixtos (ARMA).
    3.5. Representaciones AR(∞) y MA(∞).
:::

::: {.callout-tip collapse="true" icon=false}
## Unidad 4: Estimación de modelos ARMA.
...
::: {.callout-tip collapse="true" icon=false}
## Unidad 5: Predicción de modelos ARMA.
...
::: {.callout-tip collapse="true" icon=false}
## Unidad 6: Procesos No Estacionarios.
