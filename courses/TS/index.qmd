...
::: {.callout-tip appearance="simple" icon=false}
- Control 1 (C1): 27 de Abril (Capitulos 1-2)
- Pep 1 (P1): 1 de Junio (Capitulos 1-4)
- Control 1 (C2): 3 de Julio (Capitulos 5-6)
- Pep 2 (P2): 13 de Julio (Capitulos 5-7)
- Presentación Final (TF): 27 de Julio
- Examen Final: Agosto
:::
